...
public class RecoverCardsTask extends AsyncTask<String, Integer, String> {

	private ProgressDialog mProgressDialog;
	private Hashtable<String, String> parameters;
	Context context;
	public static final String RECOVER_URL = "http://mgm.funformobile.com/nc/fetchMycards.php";

	public RecoverCardsTask(Context context1) {
		context = context1;
	}

	public void doAccept(String userId) {
		mProgressDialog = new ProgressDialog(context);
		mProgressDialog.setTitle("Card Sync");
		mProgressDialog.setMessage("Syncing Cards, Please Wait");
		...
		try {
			...
			if (status.equals("OK")) {
				...
				Toast.makeText(context,
						"Contact successfully added to contacts list",
						Toast.LENGTH_LONG).show();
			} else {
	...
	public String accept(String serverUrl, Hashtable<String, String> params) {
		try {
