...
public class DeleteTask extends AsyncTask<String, Integer, String> {
	...
	Context context;
	public static final String DELETE_URL = "http://mgm.funformobile.com/nc/deleteCard.php";

	public DeleteTask(Context context1) {
		context = context1;
	}

	public void doDelete(String userId, long serverId) {
		parameters = new Hashtable<String, String>();
		parameters.put("uid", userId);
		parameters.put("server_id", String.valueOf(serverId));
		this.execute(DELETE_URL);
	}
	...
	public void showUploadSuccess(String json) {
		...
		try {
			...
			if (status.equals("OK")) {
				...
				Toast.makeText(context, "Card successfully deleted",
						Toast.LENGTH_LONG).show();
			} else {
	...
	public String delete(String serverUrl, Hashtable<String, String> params) {
		try {
