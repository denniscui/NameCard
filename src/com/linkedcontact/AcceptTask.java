...
public class AcceptTask extends AsyncTask<String, Integer, String> {
	...
	Context context;
	public static final String ACCEPT_URL = "http://mgm.funformobile.com/nc/updateContact.php";

	public AcceptTask(Context context1) {
		context = context1;
	}

	public void doAccept(String userId, long serverId) {
		mProgressDialog = new ProgressDialog(context);
		mProgressDialog.setTitle("Accept Contact");
		mProgressDialog.setMessage("Moving Contact, Please Wait");
