...
public class RemoveTask extends AsyncTask<String, Integer, String> {

	private ProgressDialog mProgressDialog;
	private Hashtable<String, String> parameters;
	Context context;
	public static final String REMOVE_URL = "http://mgm.funformobile.com/nc/removeContact.php";

	public RemoveTask(Context context1) {
		context = context1;
	}

	public void doRemove(String userId, long serverId) {
		mProgressDialog = new ProgressDialog(context);
		mProgressDialog.setTitle("Remove Contact");
		mProgressDialog.setMessage("Removing Contact, Please Wait");
	...
	public void showUploadSuccess(String json) {
		...
		try {
			...
			if (status.equals("OK")) {
				...
				Toast.makeText(context, "Contact successfully removed",
						Toast.LENGTH_LONG).show();
			} else {
	...
	public String remove(String serverUrl, Hashtable<String, String> params) {
		try {
